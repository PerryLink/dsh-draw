/**
 * The hand-written Typert HOST manifest for `dsh-draw`, exported as `./typert`
 * so the harness's typert-loader registers the `draw` status/probe/credential/
 * regenerate invocations automatically when this plugin mounts. Same shape as
