...
// = 失败。内置端点来自 cordis.patch.yml 的 engines 链；用户自建端点不可枚举，
// 不在探测范围。
import { request } from 'node:https'

const ENDPOINTS = [
  { name: 'OpenAI image API', url: 'https://api.openai.com/v1/models' },
  { name: 'Zhipu BigModel API', url: 'https://open.bigmodel.cn/api/paas/v4/chat/completions' },
]
