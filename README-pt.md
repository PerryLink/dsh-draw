...
| Superfície | Status |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.7-rc.2` (compatibilidade declarada para `0.1.5-rc.2`) |
| Node | `^22.19.0 \|\| >=24.0.0` |
...
pnpm run typecheck:ci  # tsc contra as faces publicadas 0.1.7-rc.2 (sem paths)
