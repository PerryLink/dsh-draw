...
| Superficie | Estado |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.5-rc.1` (compatibilidad declarada para `0.1.5-rc.1`) |
| Node | `^22.19.0 \|\| >=24.0.0` |
...
pnpm run typecheck:ci  # tsc contra las caras publicadas 0.1.5-rc.1 (sin paths)
