...
| Superfície | Status |
|---|---|
| Harness | DeepSeek Harness `0.1.2-alpha.5` (compatibilidade declarada para `0.1.2-alpha.5`) |
| Node | `^22.19.0 \|\| >=24.0.0` |
...
pnpm run typecheck:ci  # tsc contra as faces publicadas 0.1.2-alpha.5 (sem paths)
