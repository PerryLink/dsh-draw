...
| Superfície | Status |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.5-alpha.1` (compatibilidade declarada para `0.1.2-rc.1`) |
| Node | `^22.19.0 \|\| >=24.0.0` |
...
pnpm run typecheck:ci  # tsc contra as faces publicadas 0.1.2-rc.1 (sem paths)
