...
| सतह | स्थिति |
|---|---|
| Harness | DeepSeek Harness `dsh-v0.1.7-rc.2` (`0.1.5-rc.2` के लिए घोषित संगतता) |
| Node | `^22.19.0 \|\| >=24.0.0` |
...
pnpm run typecheck:ci  # tsc प्रकाशित 0.1.7-rc.2 फ़ेस के विरुद्ध (बिना paths)
